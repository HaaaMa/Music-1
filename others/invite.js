...
    message.reply(new MessageEmbed().setColor("RANDOM").setTitle("❤ Please Invite me: ").setDescription("https://discord.com/api/oauth2/authorize?client_id=806883898680148018&permissions=8&scope=bot")
