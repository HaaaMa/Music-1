...
client.login('Nzg1MjY2NDAwMzM1MjMzMDk3.X81WUw.o0scxDrV1CmaWWXJDmbo1-N3HS0');
...
//////////
   ...
   ///////////////////////////////
    ...
    client.user.setActivity(`Type: ${PREFIX}help | ${client.guilds.cache.size} Server/you choyn chanell and =play song`, { type: "PLAYING"});
